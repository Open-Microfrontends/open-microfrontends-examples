...
export async function startOpenMicrofrontendsExampleBrowserStandaloneSharedLibraries1(
  ...
  const renderFunction =
    exportedModules.find((m) => 'startBrowserStandaloneSharedLibrariesMicrofrontend1' in m)?.[
      'startBrowserStandaloneSharedLibrariesMicrofrontend1'
    ] ||
    exportedModules.find((m) => 'default' in m && 'startBrowserStandaloneSharedLibrariesMicrofrontend1' in m.default)
  ...
  console.info(
    '[OpenMicrofrontends] Starting Microfrontend "OpenMicrofrontends Example Browser Standalone Shared Libraries 1"'
  );
